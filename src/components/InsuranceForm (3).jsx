...
function ComprehensiveConditionalInsuranceForm() {
  ...
  const handleSubmitForm = (event) => {
    ...
    const formData = {
      ApiKey: "api-key",
      BranchCode: "orangeBD600",
      Member_name: event.target.Member_name.value,
      HealthInsuranceJson: [
        {
          // Hidden fields
          ...
          PremiumAmount: parseFloat(event.target.PremiumAmount.value) || 0,
    ...
    // Make the API call
    axios
      .post("http://localhost:3000/api/member", formData)
      .then((response) => {
